...
public class trial extends Application {
    ...
    void start1() {
        ...
        l2.setText("Press SPACE key to start!!");
    ...
    public void start(Stage window) {
        ...
        ld = new LinearGradient(0.0, 0.0, 1.0, 0.0, true, CycleMethod.NO_CYCLE, new Stop(0.0, Color.GREY),
        ...
        // Set the space background design
        Image spaceBackground = new Image("background.jpg"); // Replace with your space background image
        scene.setFill(new ImagePattern(spaceBackground));
